...
echo "This script will copy files to the Raspberry Pi and fix permissions"
...
rsync -av --exclude=".DS_Store" \
    "${LOCAL_PROJECT_DIR}/docs/" ${PI_USER}@${PI_HOST}:${PI_PROJECT_DIR}/docs/
rsync -av "${LOCAL_PROJECT_DIR}/README.md" ${PI_USER}@${PI_HOST}:${PI_PROJECT_DIR}/
